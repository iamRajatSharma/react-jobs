...
const JobListingSingle = (job) => {
    ...
    return (
        <div key={job.job.id} className="bg-white rounded-xl shadow-md relative">
            <div className="p-4">
                <div className="mb-6">
                ...
                <div className="mb-5">
                    <p>{description}</p>
                    <button onClick={() => { handler() }} className='text-indigo-500 mb-5 hover:text-indigo-700'>{!showFullDescription ? "read more" : "slow less"}</button>
                </div>
